...
class Registrar(forms.Form):
    rut = forms.CharField(label='Rut',min_length=11, max_length=12,required=True,)
    ...
    password = forms.CharField(label='Contraseña',min_length=6,max_length=30,required=True)
